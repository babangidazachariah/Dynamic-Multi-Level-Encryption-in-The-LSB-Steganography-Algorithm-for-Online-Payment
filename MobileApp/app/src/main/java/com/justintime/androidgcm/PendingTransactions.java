...
public class PendingTransactions  extends AppCompatActivity {
    ...
    // Movies json url
   // private static String url = "http://10.0.2.2/cimb.com.my/merchants/getTransactions.php";//http://api.androidhive.info/json/movies.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#1b1b1b")));
        ...
        String url = "http://104.199.190.90/cimb.com.my/merchants/getTransactions.php";//http://api.androidhive.info/json/movies.json";
        ...
        url += "?registeredDevice=" + deviceID +"&requestType=JSON&funcName=GetPendingTransactions";
        //url += "?request=JSON&agent=Pending";
        Log.w("JSONURL", url);
        supportUrl += "?registeredDevice=" + deviceID +"&requestType=IDList&funcName=GetPendingTransactions";
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                    ...
                                    Log.w("TEST", "JSON RESPONSE NEXT");
                                    Log.w("JSONRESPONSE",response.toString());
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view,
                                    ...
                                    extras.putString("agent","Pending");
    ...
    private void GetviewTransactionIDOrder(String urlSuffix){
        ...
        class GetViewList extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(PendingTransactions.this, "Retrieving Data. Please Wait...",null, true, true);
            }
